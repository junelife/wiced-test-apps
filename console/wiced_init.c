...
int sgp_shutdown( int argc, char* argv[] );
static const command_t commands[] =
{
    ALL_COMMANDS
    { (char*) "jtoggle", sgp_shutdown, 0, NULL, NULL, (char*) "", (char*) "Stops the cook session"},
    CMD_TABLE_END
};
...
void application_start( void )
{
    ...
    //platform_gpio_init(&platform_gpio_pins[WICED_GPIO_61], OUTPUT_PUSH_PULL);
